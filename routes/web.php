...
Route::group(['namespace'=>'Client','middleware' => ['checkLanguage']], function(){
    Route::post('get-variant.html','ProductController@getSku')->name('getSku');
    Route::post('/get-price', 'ProductController@getPrice')->name('getPrice');
    ...
    Route::get('/cart/sidebar', 'CartController@getCartSidebar')->name('cart.sidebar');
    ...
    Route::post('san-pham/remove-compare','ProductController@removeCompare')->name('compare.remove');
