...
@endphp
    ...
    <div class="page-blog">
        ...
        <!-- JavaScript với hiệu ứng nâng cao -->
        {{-- <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                addToCartButtons.forEach(button => {
                    button.addEventListener('click', function() {
                        ...
                        this.innerHTML =
                            '<i class="fas fa-spinner fa-spin"></i><span>Đang thêm...</span>';
                        ...
                        fetch('/cart/add', {
                            ...
                            .then(data => {
                                if (data.success) {
                                    ...
                                    this.innerHTML =
                                        '<i class="fas fa-check"></i><span>Đã thêm!</span>';
                            ...
                            .catch(error => {
                                ...
                                this.innerHTML =
                                    '<i class="fas fa-exclamation-triangle"></i><span>Lỗi!</span>';
                ...
                wishlistButtons.forEach(button => {
                    button.addEventListener('click', function() {
                        ...
                        if (icon.classList.contains('far')) {
                            ...
                            this.style.background = 'rgba(44, 44, 44, 0.9)';
                        }
                    });
                });
