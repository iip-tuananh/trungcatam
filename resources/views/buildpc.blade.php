...
@endsection
@section('css')
<link rel="preload" as="style"  href="{{env('AWS_R2_URL')}}/frontend/css/buildpc.css" type="text/css">
<link href="{{env('AWS_R2_URL')}}/frontend/css/buildpc.css" rel="stylesheet" type="text/css" media="all" />
<link rel="preload" as="style"  href="{{env('AWS_R2_URL')}}/frontend/css/product_style.scss.css" type="text/css">
<link href="{{env('AWS_R2_URL')}}/frontend/css/product_style.scss.css" rel="stylesheet" type="text/css" media="all" />
@endsection
@section('content')
